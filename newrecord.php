...
$search_qry = mysqli_query($conn, "SELECT * from student_year_info left join student_info on student_year_info.STUDENT_ID = student_info.STUDENT_ID");
$row = mysqli_query($conn,'search_qry');
